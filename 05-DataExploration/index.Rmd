...
```{r,fig.height=5,fig.width=8,dpi=150}
...
*** right
```{r,fig.height=5,fig.width=6,dpi=150}
...
```{r,warning=FALSE,message=FALSE,fig.width=7,fig.height=5,dpi=150}
...
```{r,warning=FALSE,message=FALSE,fig.width=6,fig.height=5,dpi=150}
